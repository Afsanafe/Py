...
def run():
    ...
    ########################################################################################################################################################################################################################
        #DECRYPT : Helper methods (defined before invocation)

    def decrypt_orig_text(cipher_text, key, chars):
        plain_text = ""
    ...
    def decrype_new_text(key, chars):
...
########################################################################################################################################################################################################################
    ...
    def main():
        ...
        choice = input("Would you like to decrypt this encrypted message?(Y/N) ").upper()
        


        if choice == 'Y':
            decrypt_orig_text(cipher_text, key, chars)

        choice2 = input("Would you like to decrypt another message?(Y/N) ").upper()

        if choice2 == 'Y':
            decrype_new_text(key, chars)
